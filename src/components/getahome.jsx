...
const GetAHome = () => {
  return (
    <section className="relative w-full min-h-screen pt-28 lg:pt-32 overflow-hidden bg-white">
      {/* Overlay */}
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-12 flex flex-col items-center text-center">
        <FadeInText delay={0}>
          <h1 className="text-4xl sm:text-6xl lg:text-7xl font-extrabold uppercase tracking-tight text-amber-200 leading-tight">
            GET A HOME
          </h1>
        </FadeInText>
      ...
      <div
        className="text-4xl sm:text-6xl lg:text-8xl font-extrabold uppercase tracking-tight leading-tight absolute bottom-20 left-0 w-full text-center text-transparent bg-clip-text bg-linear-to-r from-amber-200 via-lime-500 to-amber-200 bg-size-[200%_100%] opacity-20"
      >
